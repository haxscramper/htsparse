...
type
  AgdaNodeKind* = enum
    ...
    agdaSingleRCurlyTok,    ## }
    agdaDoubleRCurlyTok,    ## }}
    agdaSingle‚Single¶SingleÉTok, ## ‚¶É
    agdaSingle‚Single¶SingleÑTok, ## ‚¶Ñ
    agdaSingle‚Single¶SingleáTok, ## ‚¶á
    agdaSingle‚Single¶SingleàTok, ## ‚¶à
...
proc kind*(node: AgdaNode): AgdaNodeKind =
  ...
  of "}}":
    agdaDoubleRCurlyTok
  of "‚¶É":
    agdaSingle‚Single¶SingleÉTok
  of "‚¶Ñ":
    agdaSingle‚Single¶SingleÑTok
  of "‚¶á":
    agdaSingle‚Single¶SingleáTok
  of "‚¶à":
    agdaSingle‚Single¶SingleàTok
  of "ERROR":
    agdaSyntaxError
  else:
