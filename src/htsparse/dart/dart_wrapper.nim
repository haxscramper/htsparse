...
proc kind*(node: DartNode): DartNodeKind {.noSideEffect.} =
  {.cast(noSideEffect).}:
    ...
    of "assertion":
      dartAssertion
    of "assignable_expression":
      dartAssignableExpression
    of "assignment_expression":
      dartAssignmentExpression
    of "assignment_expression_without_cascade":
      dartAssignmentExpressionWithoutCascade
    of "await_expression":
      dartAwaitExpression
    of "binary_operator":
      dartBinaryOperator
    of "bitwise_and_expression":
      dartBitwiseAndExpression
    of "bitwise_operator":
      dartBitwiseOperator
    of "bitwise_or_expression":
      dartBitwiseOrExpression
    of "bitwise_xor_expression":
    ...
    of "do_statement":
      dartDoStatement
    of "dotted_identifier_list":
      dartDottedIdentifierList
    of "enum_body":
      dartEnumBody
    of "enum_constant":
      dartEnumConstant
    ...
    of "extension_body":
      dartExtensionBody
    of "extension_declaration":
      dartExtensionDeclaration
    of "factory_constructor_signature":
      dartFactoryConstructorSignature
    of "false":
      dartFalse
    of "field_initializer":
      dartFieldInitializer
    of "finally_clause":
      dartFinallyClause
    of "for_element":
      dartForElement
    ...
    of "formal_parameter":
      dartFormalParameter
    of "formal_parameter_list":
      dartFormalParameterList
    of "function_body":
      dartFunctionBody
    of "function_expression":
      dartFunctionExpression
    of "function_expression_body":
      dartFunctionExpressionBody
    ...
    of "if_element":
      dartIfElement
    of "if_null_expression":
      dartIfNullExpression
    of "if_statement":
      dartIfStatement
    of "import_or_export":
      dartImportOrExport
    of "import_specification":
      dartImportSpecification
    of "inferred_type":
      dartInferredType
    of "initialized_identifier":
      dartInitializedIdentifier
    of "initialized_identifier_list":
      dartInitializedIdentifierList
    of "initialized_variable_definition":
      dartInitializedVariableDefinition
    of "initializer_list_entry":
      dartInitializerListEntry
    of "initializers":
      dartInitializers
    of "interfaces":
      dartInterfaces
    ...
    of "labeled_statement":
      dartLabeledStatement
    of "lambda_expression":
      dartLambdaExpression
    of "library_export":
      dartLibraryExport
    of "library_import":
      dartLibraryImport
    ...
    of "local_variable_declaration":
      dartLocalVariableDeclaration
    of "logical_and_expression":
      dartLogicalAndExpression
    of "logical_or_expression":
      dartLogicalOrExpression
    of "marker_annotation":
      dartMarkerAnnotation
    of "method_signature":
      dartMethodSignature
    of "mixin_application":
      dartMixinApplication
    of "mixin_application_class":
      dartMixinApplicationClass
    of "mixin_declaration":
    ...
    of "multiplicative_operator":
      dartMultiplicativeOperator
    of "named_argument":
      dartNamedArgument
    of "named_parameter_types":
      dartNamedParameterTypes
    of "negation_operator":
      dartNegationOperator
    of "new_expression":
      dartNewExpression
    of "normal_parameter_type":
      dartNormalParameterType
    of "null_literal":
      dartNullLiteral
    of "operator_signature":
      dartOperatorSignature
    of "optional_formal_parameters":
      dartOptionalFormalParameters
    of "optional_parameter_types":
      dartOptionalParameterTypes
    of "optional_positional_parameter_types":
      dartOptionalPositionalParameterTypes
    of "pair":
      dartPair
    of "parameter_type_list":
      dartParameterTypeList
    of "parenthesized_expression":
      dartParenthesizedExpression
    of "part_directive":
      dartPartDirective
    of "part_of_directive":
      dartPartOfDirective
    ...
    of "qualified":
      dartQualified
    of "redirecting_factory_constructor_signature":
      dartRedirectingFactoryConstructorSignature
    of "redirection":
      dartRedirection
    of "relational_expression":
    ...
    of "scoped_identifier":
      dartScopedIdentifier
    of "script_tag":
      dartScriptTag
    of "selector":
      dartSelector
    of "set_or_map_literal":
      dartSetOrMapLiteral
    of "setter_signature":
      dartSetterSignature
    of "shift_expression":
    ...
    of "spread_element":
      dartSpreadElement
    of "static_final_declaration":
      dartStaticFinalDeclaration
    of "static_final_declaration_list":
    ...
    of "template_substitution":
      dartTemplateSubstitution
    of "this":
      dartThis
    of "throw_expression":
      dartThrowExpression
    of "throw_expression_without_cascade":
    ...
    of "type_test":
      dartTypeTest
    of "type_test_expression":
      dartTypeTestExpression
    of "typed_identifier":
      dartTypedIdentifier
    of "unary_expression":
      dartUnaryExpression
    of "unconditional_assignable_selector":
    ...
    of "while_statement":
      dartWhileStatement
    of "yield_each_statement":
      dartYieldEachStatement
    of "yield_statement":
      dartYieldStatement
    of "\n":
      dartNewlineTok
    ...
    of "do":
      dartDoTok
    of "documentation_comment":
      dartDocumentationComment
    of "dynamic":
      dartDynamicTok
    of "else":
      dartElseTok
    ...
    of "hex_integer_literal":
      dartHexIntegerLiteral
    of "hide":
      dartHideTok
    of "identifier_dollar_escaped":
