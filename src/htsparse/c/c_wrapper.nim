...
proc treeReprTsC*(str: string, unnamed: bool = false): ColoredText =
...
proc parseCString*(str: string, unnamed: bool = false): CNode =
  let parser = newTsCParser()
  return toHtsTree[TsCNode, CNodeKind](parseString(parser, str), unsafeAddr str, storePtr = false)
