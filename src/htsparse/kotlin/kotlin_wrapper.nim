...
type
  KotlinNodeKind* = enum
    ...
    kotlinSingleExclamationTok, ## !
    kotlinDoubleExclamationTok, ## !!
    kotlinSingleExclamationSingleEqualTok, ## !=
    kotlinSingleExclamationDoubleEqualTok, ## !==
    kotlinSingleExclamationinTok, ## !in
    kotlinSingleQuoteTok,   ## "
    kotlinTripleQuoteTok,   ## """
    kotlinSingleHashSingleExclamationTok, ## #!
    kotlinSingleDollarTok,  ## $
    kotlinSingleDollarSingleLCurlyTok, ## ${
    kotlinSinglePercentTok, ## %
    kotlinSinglePercentSingleEqualTok, ## %=
    kotlinDoubleAmpersandTok, ## &&
    kotlinSingleApostropheTok, ## '
    kotlinSingleLParTok,    ## (
    kotlinSingleRParTok,    ## )
    kotlinSingleAsteriskTok, ## *
    kotlinSingleAsteriskSingleEqualTok, ## *=
    kotlinSinglePlusTok,    ## +
    kotlinDoublePlusTok,    ## ++
    kotlinSinglePlusSingleEqualTok, ## +=
    kotlinSingleCommaTok,   ## ,
    kotlinSingleMinusTok,   ## -
    kotlinDoubleMinusTok,   ## --
    kotlinSingleMinusSingleEqualTok, ## -=
    kotlinSingleMinusSingleGreaterThanTok, ## ->
    kotlinSingleDotTok,     ## .
    kotlinSingleDotSingleAsteriskTok, ## .*
    kotlinDoubleDotTok,     ## ..
    kotlinSingleSlashTok,   ## /
    kotlinSingleSlashSingleEqualTok, ## /=
    kotlinSingleColonTok,   ## :
    kotlinDoubleColonTok,   ## ::
    kotlinSingleSemicolonTok, ## ;
    kotlinSingleLessThanTok, ## <
    kotlinSingleLessThanSingleEqualTok, ## <=
    kotlinSingleEqualTok,   ## =
    kotlinDoubleEqualTok,   ## ==
    kotlinTripleEqualTok,   ## ===
    kotlinSingleGreaterThanTok, ## >
    kotlinSingleGreaterThanSingleEqualTok, ## >=
    kotlinSingleQuestionSingleColonTok, ## ?:
    kotlinSingleAtTok,      ## @
    kotlinLTok,             ## L
    kotlinSingleLBrackTok,  ## [
    kotlinSingleBackslashTok, ## \
    kotlinSingleRBrackTok,  ## ]
    kotlinAbstractTok,      ## abstract
    kotlinActualTok,        ## actual
    kotlinAnnotationTok,    ## annotation
    kotlinAsTok,            ## as
    kotlinAsSingleQuestionTok, ## as?
    kotlinBinLiteral,       ## bin_literal
    kotlinBreakTok,         ## break
    kotlinBreakSingleAtTok, ## break@
    kotlinByTok,            ## by
    ...
    kotlinContinueSingleAtTok, ## continue@
...
proc kind*(node: KotlinNode): KotlinNodeKind =
  ...
  of "as":
    kotlinAsTok
  of "as?":
    kotlinAsSingleQuestionTok
  of "bin_literal":
    kotlinBinLiteral
  of "break":
    kotlinBreakTok
  of "break@":
    kotlinBreakSingleAtTok
  of "by":
    kotlinByTok
  of "catch":
    kotlinCatchTok
...
proc slice*(node: KotlinNode): Slice[int] =
